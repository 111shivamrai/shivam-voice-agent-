...
-- ============================================
-- Voice AI Agent Platform — Phase 3 Schema: Payments & Minutes System
-- ============================================

-- 15. Create payment_requests table
...
-- 18. RLS Policies: Clients can only view and create their own payment requests
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 19. Grants: Clients may only SELECT and INSERT; UPDATE and DELETE reserved for backend service_role
